...
- 2x PJ320A 1/8(3.5mm) TRRS 커넥터 (약 1천원)

- 2x 4x4x1.5mm 스위치 (약 1천원)

- 1x 1/8(3.5mm) TRRS 케이블 (약 3천원, TRS 케이블도 사용할 수 있습니다)
...
하나 만드는 데 약 7만8천원~11만4천원(배송비 제외)이 필요합니다. 키캡이나 케이스쪽에서 가격을 더 절약할 수 있습니다.
